<form action="" class="md:w-1/2 space-y-5" autocomplete="off" wire:submit.prevent='editarVacante'>
    <div>
    ...
    <div>
        ...
        <x-text-input id="imagen" class="block mt-1 w-full" type="file" wire:model="imagenNueva" accept="image/*" />
